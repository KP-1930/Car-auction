...
<!-- // all search in one
 <div class="container">
    ...
    <div class="input-group">
        <input type="search" name="search" placeholder="Search.."  id = "search"  value="{{request('search')}}"/>
...
<div class="container">
    <!-- <form method="POST" action = "{{url('particularsearch')}}"> -->
    {{ Form::open(array('url' => 'particularsearch')) }}
    @csrf
    <div class="row mb-5 ">
    <div class="col-lg-6 ">
